...
interface OrphanagesDetailsRouteParamsI {
  id: number;
}

interface OrphanageI {
  id: number;
  name: string;
  latitude: number;
  longitude: number;
...
export default function OrphanageDetails() {
  ...
  const [orphanage, setOrphanage] = useState<OrphanageI>();

  const params = route.params as OrphanagesDetailsRouteParamsI;
  ...
  if (!orphanage) {
    return (
      <View style={styles.container}>
        {/* Fazer um estilo SHEAMER - Blog rocketseat - minuto 43:47 NLW 03  */}
